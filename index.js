...
async function handleStartCommand(ctx) {
  ...
  if (isSubscribed) {
    ...
    await ctx.reply(
      'Чтобы скачать полезные файлы 📚 по математике нужно подписаться на канал! Упс!😱 Кажется, ты не подписался! Подпишись и всё получится!✅ Обнял приподнял, в лобик поцеловал.',
      Markup.inlineKeyboard([
